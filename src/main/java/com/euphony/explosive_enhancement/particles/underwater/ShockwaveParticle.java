...
public class ShockwaveParticle extends TextureSheetParticle {
    ...
    ShockwaveParticle(ClientLevel world, double x, double y, double z, double velX, double velY, double velZ, SpriteSet spriteProvider) {
        super(world, x, y, z);
    ...
    public void tick() {
        ...
        if (this.age++ >= this.lifetime) {
            ...
            if (this.age >= this.lifetime * 0.65 && CONFIG.showUnderwaterSparks) {
                this.level.addParticle(ExplosiveEnhancement.UNDERWATERSPARKS.get(), important, this.x, this.y, this.z, quadSize, this.yd, this.zd);
            }
